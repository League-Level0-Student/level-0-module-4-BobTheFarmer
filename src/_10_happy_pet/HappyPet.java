...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		int pet = JOptionPane.showOptionDialog(null, "What pet do you want?", "Stop reading and choose a pet", 0, JOptionPane.INFORMATION_MESSAGE, null,
				new String[] { "Cat", "Dog", "Hamster", "Fish"}, null);
		if(pet==0) {
		JOptionPane.showMessageDialog(null, "Reconsider you life choises");
		happinessLevel = -10000;
		}
		int task = JOptionPane.showOptionDialog(null, "What will you do to make your pet happy?", "Make your pet less deppresed", 0, JOptionPane.INFORMATION_MESSAGE, null,
